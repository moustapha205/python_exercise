...
json_string = json.dumps(commandes, indent=2, ensure_ascii=False)
print("=== JSON généré ===")
print(json_string)


with open("/Users/mac/Desktop/python/serie2/commandes.json", "w", encoding="utf-8") as f:
    json.dump(commandes, f, indent=2, ensure_ascii=False)

print("\nFichier commandes.json créé ✔️")
